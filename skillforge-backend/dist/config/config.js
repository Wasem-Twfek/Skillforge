...
console.log('Config loaded:', {
    ...
    DATABASE_URL: exports.config.DATABASE_URL,
    GOOGLE_CLIENT_ID: exports.config.GOOGLE_CLIENT_ID ? 'Set' : 'Not set',
    GOOGLE_CLIENT_SECRET: exports.config.GOOGLE_CLIENT_SECRET ? 'Set' : 'Not set',
    GOOGLE_REDIRECT_URI: exports.config.GOOGLE_REDIRECT_URI
});
